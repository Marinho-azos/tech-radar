...
const getQuadrants = () => {
  return JSON.parse(process.env.QUADRANTS || null) || ['Técnicas', 'Plataformas', 'Ferramentas', 'Linguagens e frameworks']
}

const getRings = () => {
  return JSON.parse(process.env.RINGS || null) || ['Adote', 'Teste', 'Avalie', 'Cuidado']
}
